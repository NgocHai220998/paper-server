...
class PapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post papers_url, params: { paper: { group_id: @paper.group_id, image: @paper.image, name: @paper.name, order: @paper.order } }, as: :json
    end
  ...
  test "should update paper" do
    patch paper_url(@paper), params: { paper: { group_id: @paper.group_id, image: @paper.image, name: @paper.name, order: @paper.order } }, as: :json
    assert_response 200
  end
